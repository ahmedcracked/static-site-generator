...
class TestLeafNode(unittest.TestCase):
    ...
    def test_leaf_to_html_no_tag(self):
        node = LeafNode(None, "hi mom!")
        self.assertEqual(node.to_html(), "hi mom!")
...
class TestParentNode(unittest.TestCase):
    ...
    def test_to_html_with_props(self):
        parent_node = ParentNode(
            "a", [LeafNode("b", "grandchild")], {"href": "https://google.com"}
        )
        self.assertEqual(
            parent_node.to_html(), '<a href="https://google.com"><b>grandchild</b></a>'
        )
